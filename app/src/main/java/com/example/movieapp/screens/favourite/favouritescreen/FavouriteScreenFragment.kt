...
import com.example.movieapp.screens.favourite.favouriteviewmodel.FavouriteViewModelFactory
import com.example.movieapp.screens.favourite.favouriteviewmodel.favouriteViewMod
...
class FavouriteScreenFragment :Fragment(){
    ...
    private val favViewMod by viewModels<favouriteViewMod>{
        FavouriteViewModelFactory(
            (requireContext().applicationContext as MovieApplication).movieRepoInterface
        )
    }
    override fun onCreateView(
        ...
        adapter =
            FavouriteMovieAdapter(
                ...
                val action =
                    FragmentMainDirections.actionMovieFragmentToSingleFavouriteFragment(movies)
